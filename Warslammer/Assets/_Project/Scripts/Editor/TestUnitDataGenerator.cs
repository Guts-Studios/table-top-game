...
{
    /// <summary>
    /// Editor utility to quickly generate test unit data assets
    /// </summary>
    public class TestUnitDataGenerator : EditorWindow
    {
        [MenuItem("Warslammer/Testing/Generate Test Units")]
        public static void GenerateTestUnits()
        {
            ...
            {
                AssetDatabase.CreateFolder("Assets/_Project/Data", "Units");
            }
            ...
            Debug.Log("[TestUnitDataGenerator] Created 4 test unit data assets in " + folderPath);
        }
